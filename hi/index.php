...
<option value="-1" > <b>सभी</b></option>
			     ...
			     <?php
					...
					{
	  		  ?>
		<option value="<?php echo $row['id']; ?>" > <b><?php echo $row['hSchemeName']; ?></option>
		<?php 
		}	
		?>
		   </select>
                            <div class="input-group-btn">
                                <button class="btn btn-default input-lg noborder-left">
                                    <i class="fas fa-search fa-lg nopadding"></i>
                                </button>
                            </div>
                        </div>
				...
				<div class="heading-title text-left heading-line-single ">
					...
					<div class="schm-ctgr" style="padding-bottom:20px">
						<?php 
							 ...
							 { ?>
					 <div class="ctgr-block"> <a href="#" class="category-home"> <i class="fas fa-angle-right margin-right-6">	</i> <?php echo $row['hCategoryName']; } ?> </a> </div> <!--- closing of category --->		
