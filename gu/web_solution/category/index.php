...
<body>
	...
	<div class="container">
        ...
        <button class="btn btn-info" type="button" id="btn-add"> <span> <i class="fas fa-edit" aria-hidden="true"></i></span> &nbsp; Add Category Details</button>
        <button class="btn btn-info" type="button" id="btn-view"> <span><i class="fas fa-eye" aria-hidden="true"></i></span> &nbsp; View Details</button>
        <button class="btn btn-info" type="button" name="btn-approv" id="btn-approv"> <span><i class="fas fa-eye" aria-hidden="true"></i></span> &nbsp; Approved</button>
        <button class="btn btn-info" type="button" name="btn-pending" id="btn-pending"> <span><i class="fas fa-eye" aria-hidden="true"></i></span> &nbsp; Pending</button>
        <hr />
