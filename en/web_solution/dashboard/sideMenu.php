        ...
        <div class="row">
          <div class="col-md-2 col-sm-12 side-menu-block">
            ...
            <div class="list-group side-menu">
			  ...
			  <a href="../office_reference" class="list-group-item"><i class="fas fa-building" aria-hidden="true"></i> Office <span class="badge"><?php  echo countRow("office","deleted = 0  "); ?></span></a>
              ...
              <a href="../district" class="list-group-item"><span class="glyphicon glyphicon-map-marker"></span> District <span class="badge"><?php echo countRow("district","deleted = 0 "); ?></span></a>
               <a href="../country" class="list-group-item"><span class="glyphicon glyphicon-map-marker"></span> Country <span class="badge"><?php echo countRow("country","deleted = 0 "); ?></span></a>
                <a href="../village" class="list-group-item"><span class="glyphicon glyphicon-map-marker"></span> Village <span class="badge"><?php echo countRow("village","deleted = 0 "); ?></span></a>
