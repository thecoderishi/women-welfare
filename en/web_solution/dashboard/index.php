 ...
 <div class="col-md-9">
            ...
            <div class="panel panel-default">
			  ...
			  <div class="row">
				...
				<a href="../village/">
                  <div class="well dash-box">
                    <h2><i class="fas fa-map-marker" aria-hidden="true"></i>  <?php echo countRow("village","deleted = 0 ") ;?></h2>
                    <h4>Village</h4>
                  </div>
				  </a>
                </div>
				...
				<a href="../country/">
                  <div class="well dash-box">
                    <h2><span class="glyphicon glyphicon-map-marker" style="color:#000"></span>  <?php echo countRow("country","deleted = 0 ") ;?></h2>
                    <h4>Country</h4>
                  </div>
				  </a>
                </div>
